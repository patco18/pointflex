#!/usr/bin/env python3
"""
Script pour corriger les importations dans les fichiers de modèles
"""
...
def fix_imports_in_file(file_path):
    ...
    # Corriger les importations de middleware, utils, etc.
...
if __name__ == "__main__":
    ...
    print(f"Correction des importations dans: {models_dir}")
    fix_imports_in_directory(models_dir)
    print("Terminé!")
