#!/usr/bin/env python3
"""
Script pour corriger les importations dans les fichiers de route
"""
...
def fix_imports_in_file(file_path):
    ...
    # Corriger les importations de middleware, models, etc.
    ...
    content = re.sub(r'from routes\.', r'from backend.routes.', content)
...
if __name__ == "__main__":
    ...
    routes_dir = os.path.abspath('backend/routes')
    print(f"Correction des importations dans: {routes_dir}")
    fix_imports_in_directory(routes_dir)
    print("Terminé!")
