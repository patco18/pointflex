#!/usr/bin/env python3
"""
Script pour corriger les importations dans les fichiers utils
"""
...
if __name__ == "__main__":
    # Répertoire utils
    utils_dir = os.path.abspath('backend/utils')
    print(f"Correction des importations dans: {utils_dir}")
    fix_imports_in_directory(utils_dir)
    print("Terminé!")
